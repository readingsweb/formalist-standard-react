...
export var display = /*#__PURE__*/css(inputBoxes.inputBox, ";");

export var wrapper = /*#__PURE__*/css("align-items:center;display:flex;padding:0;width:100%;&:focus{outline:none;}");

export var selectionItems = /*#__PURE__*/css(typography.normal, ";", typography.sans, ";margin-top:1px;");
...
export var selection = /*#__PURE__*/css("flex:1;strong{font-weight:", typography.fonts.weights.sansBold, ";}italic{font-style:italic;}");

export var selectedItems = uid(10); // Empty placeholder class