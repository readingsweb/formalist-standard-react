...
var defaults = {
  blockFormatters: ["unstyled", "header-one", "header-two", "header-three", "unordered-list-item", "ordered-list-item", "blockquote", "pullquote", "code-block", "horizontal-rule"],
  blockSet: {
    atomic: {
...
export default function blockToolbarPlugin() {
  ...
  var _options = options,
      ...
      embeddableFormsPrefix = _options.embeddableFormsPrefix,
      ...
      if (type && blockSet[type]) {
        ...
        if (type === "atomic") {
          var atomicProps = mergeDefaults({
            ...
            embeddableFormsPrefix: embeddableFormsPrefix,
            fieldBus: fieldBus,
