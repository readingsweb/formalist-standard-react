  ...
  _createClass(AtomicBlock, [{
    ...
    value: function componentWillMount() {
      ...
      var _props$blockProps = this.props.blockProps,
          fieldBus = _props$blockProps.fieldBus,
          embeddableFormsPrefix = _props$blockProps.embeddableFormsPrefix;
    ...
    value: function componentWillUnmount() {
      var _props$blockProps2 = this.props.blockProps,
          fieldBus = _props$blockProps2.fieldBus,
          editorEmitter = _props$blockProps2.editorEmitter,
          embeddableFormsPrefix = _props$blockProps2.embeddableFormsPrefix;
